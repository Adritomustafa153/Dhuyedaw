<?php
    $con = mysqli_connect('localhost', 'root', '', 'dhuyadaw');
    $que = "SELECT `item_name`, `Shoe_polish` FROM price_chart WHERE Shoe_polish!=0;";
...
<html lang="en">
  ...
  <body>
    <nav class="w3-bar w3-black">
        <a href="price.html" class="w3-button w3-bar-item">HOME PAGE</a>
